...
public class JavaMailUtils {
     ...
     * @param body
     */
    public static void sendAttachmentEmail(Session session, String fromEmail, String toEmail, String replayToEmail, String subject, String body, FileDataSource fileDataSource){
        try{
            MimeMessage msg = new MimeMessage(session);
            msg.addHeader("Content-type", "text/HTML; charset=UTF-8");
            msg.addHeader("format", "flowed");
     ...
     * @param body
     */
    public static void sendImageEmail(Session session,  String fromEmail, String toEmail, String replayToEmail, String subject, String body, FileDataSource fileDataSource){
        try{
            MimeMessage msg = new MimeMessage(session);
            msg.addHeader("Content-type", "text/HTML; charset=UTF-8");
            msg.addHeader("format", "flowed");
